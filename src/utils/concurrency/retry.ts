 ...
 *
 * @param asyncFn - Async function to retry (must return a Promise).
 * @param maxRetries - Maximum number of retry attempts.
 * @param initialDelay - Initial delay in ms (1s, 2s, 4s exponential).
 * @returns Result of the successful call or throws the last error.
 */
