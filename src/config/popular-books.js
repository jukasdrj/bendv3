 ...
 * @returns {string[]} Array of ISBN-13 strings
 */
export function getPopularISBNs() {
  return [...POPULAR_ISBNS]
}

/**
 * Check if an ISBN is in the popular books list
 * @param {string} isbn - ISBN to check (10 or 13 digits)
 * @returns {boolean} True if ISBN is in popular list
 */
export function isPopularBook(isbn) {
 ...
 * @returns {number} Total number of popular ISBNs
 */
export function getPopularBooksCount() {
