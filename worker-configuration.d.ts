/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4b2df93f075e230095265d083409cb88)
// Runtime types generated with workerd@1.20251210.0 2025-11-14 cache_no_cache_enabled,enable_request_signal,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RateLimiterDO" | "WebSocketConnectionDO" | "JobStateManagerDO" | "CacheMetricsDO" | "LatencyTestDO";
	}
	interface Env {
		CACHE: KVNamespace;
		RECOMMENDATIONS_CACHE: KVNamespace;
		"//": "========================================================================";
		...
		WEBSOCKET_CONNECTION_DO: DurableObjectNamespace<import("./src/index").WebSocketConnectionDO>;
		JOB_STATE_MANAGER_DO: DurableObjectNamespace<import("./src/index").JobStateManagerDO>;
		CACHE_METRICS_DO: DurableObjectNamespace<import("./src/index").CacheMetricsDO>;
		LATENCY_TEST_DO: DurableObjectNamespace<import("./src/index").LatencyTestDO>;
		BOOKSHELF_IMAGES: R2Bucket;
		BOOK_COVERS: R2Bucket;
		DB: D1Database;
		GEMINI_API_KEY: SecretsStoreSecret;
		ALEXANDRIA: Service /* entrypoint default from alexandria */;
		...
		ALEXANDRIA_COVER_QUEUE: Queue;
		BOOK_VECTORS: VectorizeIndex;
		AI: Ai;
		BOOK_IMPORT_WORKFLOW: Workflow<Parameters<import("./src/index").BookImportWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "//" | "WORKFLOW_ROLLOUT_PERCENT" | "ENABLE_WORKFLOW_IMPORT" | "CACHE_HOT_TTL" | "CACHE_COLD_TTL" | "MAX_RESULTS_DEFAULT" | "RATE_LIMIT_MS" | "CONCURRENCY_LIMIT" | "AGGRESSIVE_CACHING" | "V3_MAX_SEARCH_RESULTS" | "V3_ENRICH_STREAMING_THRESHOLD" | "V3_ENRICH_CONCURRENCY" | "ACCESS_TRACKING_SAMPLE_RATE" | "CACHE_ALERT_HIT_RATE_THRESHOLD_CRITICAL" | "CACHE_ALERT_HIT_RATE_THRESHOLD_WARNING" | "CACHE_ALERT_HOT_CACHE_THRESHOLD_CRITICAL" | "CACHE_ALERT_HOT_CACHE_THRESHOLD_WARNING" | "CACHE_ALERT_DROP_THRESHOLD_CRITICAL" | "CACHE_ALERT_DROP_THRESHOLD_WARNING" | "ALERT_FROM_EMAIL" | "ALERT_TO_EMAIL" | "LOG_LEVEL" | "ENABLE_PERFORMANCE_LOGGING" | "ENABLE_CACHE_ANALYTICS" | "ENABLE_PROVIDER_METRICS" | "ENABLE_RATE_LIMIT_TRACKING" | "STRUCTURED_LOGGING" | "OPENLIBRARY_BASE_URL" | "USER_AGENT" | "AI_PROVIDER" | "MAX_IMAGE_SIZE_MB" | "REQUEST_TIMEOUT_MS" | "CONFIDENCE_THRESHOLD" | "MAX_SCAN_FILE_SIZE" | "ENABLE_HIBERNATION_WEBSOCKET" | "ENABLE_D1_WRITES" | "D1_READ_PERCENTAGE" | "D1_MIGRATION_BATCH_SIZE" | "VALIDATE_DUAL_WRITES" | "ENABLE_ALEXANDRIA_RPC" | "ISBNDB_API_KEY">> {}
}
